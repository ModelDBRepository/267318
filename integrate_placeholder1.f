c 23 Aug 2019: supbask not used in initial version of piriform.f
c so this used as a placeholder
! Integration program for superior & deep basket & axo-axonic cells
! From baskn.f in supergj.f

c      SUBROUTINE integrate_supbaskx (O, time, numcell, V, curr,
       SUBROUTINE integrate_placeholder1 (O, time, numcell, V, curr,
