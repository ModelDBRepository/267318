c 23 AUG 2019, supLTS not used in initial piriform.f
c so becomes placeholder3
! Integration program for superior & deep LTS cells
! From ltsi.f in supergj.f

c      SUBROUTINE integrate_supLTSX (O, time, numcell, V, curr,
       SUBROUTINE integrate_placeholder3 (O, time, numcell, V, curr,
