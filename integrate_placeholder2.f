c 23 Aug 2019: supaxax not used in initial piriform.f
c so becomes placeholder2

! Integration program for superior & deep basket & axo-axonic cells
! From baskn.f in supergj.f

c      SUBROUTINE integrate_supaxax (O, time, numcell, V, curr,
       SUBROUTINE integrate_placeholder2 (O, time, numcell, V, curr,
...
c as follows:
     ...
     X    alpham_ar , betam_ar , dalpham_ar , dbetam_ar)
        ...
        CALL placeholder2MAJ (GL,GAM,GKDR,GKA,GKC,GKAHP,GK2,GKM,
