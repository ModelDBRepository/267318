c 23 Aug 2019 code taken from son_of_groucho spinstell integration
c In piriform, use to generate afferent inputs, e.g. by current
c pulses to axons
...
c      SUBROUTINE integrate_spinstelldiegoxB (O, time, numcell, V, curr,
       SUBROUTINE integrate_LOT              (O, time, numcell, V, curr,
